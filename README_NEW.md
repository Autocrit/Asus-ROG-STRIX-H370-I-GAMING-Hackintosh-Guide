...
## OpenCore guide
I followed the [Dortania](https://dortania.github.io/OpenCore-Install-Guide/) guide step-by-step and so far the results are good. I'm new to OpenCore so I'll only add a few comments.
